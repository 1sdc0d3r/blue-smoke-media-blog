exports.seed = function (knex) {
  ...
  return knex('Articles').del()
    .then(function () {
      ...
      return knex('Articles').insert( //! 19 articles
  ...
  <span>FACT:</span> You have only 10 seconds to attract your potential customers and get them to stay long enough to show them your business is the best choice. How's your website Doing? Take the 'Check and Correct Quiz' below to see if your website measures up. After your input what you don't know will be clearer. If you want your website to be more effective, stay open and learn how you can put more money in your checking account each month.
